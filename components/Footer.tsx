  ...
  return (
    <div className="w-full pt-16 pb-8 md:pb-12 flex flex-col md:flex-row justify-between items-center gap-6 px-4 sm:px-margin-edge border-t border-slate-200 dark:border-white/15 relative z-20 overflow-hidden transition-colors duration-400">
      ...
      <div className="flex flex-wrap justify-center items-center gap-6 sm:gap-8 md:gap-10 relative z-10">
        <a
          className="font-label-caps text-label-caps text-slate-700 dark:text-white/85 hover:text-emerald-600 dark:hover:text-emerald-400 transition-colors duration-300 flex items-center gap-2 group font-semibold"
          href={fbUrl}
          target="_blank"
          rel="noopener noreferrer"
        >
          <svg className="w-4 h-4 fill-current group-hover:scale-110 transition-transform text-slate-700 dark:text-white/90 group-hover:text-emerald-600 dark:group-hover:text-emerald-400" viewBox="0 0 24 24">
      ...
      <div className="font-label-caps text-label-caps text-slate-500 dark:text-white/60 text-center md:text-right opacity-75 hover:opacity-100 transition-opacity duration-300 relative z-10 font-mono text-[10px]">
